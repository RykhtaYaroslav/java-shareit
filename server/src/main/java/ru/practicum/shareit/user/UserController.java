...
public class UserController {
    ...
    public UserDto create(@RequestBody UserDtoCreateRequest createRequest) {
        return userService.create(createRequest);
    }

    @PatchMapping("/{userId}")
    public UserDto update(@PathVariable Long userId, @RequestBody UserDtoUpdateRequest updateRequest) {
